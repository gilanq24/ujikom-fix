    ...
    $ceknis    =mysqli_num_rows (mysqli_query($koneksi, "SELECT nis FROM siswa WHERE nis='$_POST[nis]'"));
    ...
    <?php
        ...
        $insert =mysqli_query($koneksi, "INSERT INTO siswa (nis,kelas,nama_siswa) VALUES ('$nis', '$kelas','$nama_siswa')");
    }

        ?>
            <script language="JavaScript">
            alert('Good! Tambah Pelanggan Berhasil ...');
...
tbody tr td{
 ...
 <p align="center" style="margin-top:1px; margin-left: 1200px">Anda Login Sebagai {(Admin)} <button style="width: 60px;margin-left:10px;background-color:orangered ;height:25px"><a href="../login/index.php" style="font-size: 15px;color: white;">Logout</a></button></p>
    <h3 style="margin-left: 300px;margin-top: 175px;">Tambah Pelanggan</h3>
    <br>
                                ...
                                <div class="col-md-12">
                                    <form method="POST">
                                        <div class="form-group">
                                            <label>Nis</label>
                                            <input class="form-control" id="nis" style="margin-left:124px;width: 300px;height: 20px;"name="nis" />

                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label>Kelas</label>
                                            <input class="form-control" id="kelas" style="width: 300px;margin-left: 107px;height: 20px;"name="kelas" />
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label>Nama Siwa</label>
                                            <input class="form-control" id="nama_siswa" style="width: 300px;margin-left: 66px;height: 20px;"name="nama_siswa" />
                                        </div>
                                        <br>
                                    <input type="submit" name="ubah" value="Simpan" class="btn btn-primary"style="margin-left:152px;height: 25px;width: 100px;">
                                    <button style="background-color: royalblue; margin-left:100px;height: 25px;width: 100px;"><a href="../Admin/siswa.php" style="color:white;">Kembali</button>
                                </div>
                            </div>
