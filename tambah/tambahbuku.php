    ...
    $cekkode    =mysqli_num_rows (mysqli_query($koneksi, "SELECT kode FROM buku WHERE kode='$_POST[kode]'"));
    
    if($cekkode < 0) {
    ?>
        <script language="JavaScript">
            alert('Oops! Duplikat kode ...');
            document.location='tambahbuku.php';
        </script>
    <?php
    }
        
    else{
        $insert =mysqli_query($koneksi, "INSERT INTO buku (kode,kategori,judul_buku) VALUES ('$kode','$kategori','$judul_buku')");
    }

        ?>
            <script language="JavaScript">
            alert('Good! Input Data Bolu Berhasil ...');
...
tbody tr td{
 ...
 <p align="center" style="margin-top:1px; margin-left: 1200px">Anda Login Sebagai {(Admin)} <button style="width: 60px;margin-left:10px;background-color:orangered ;height:25px"><a href="../login/index.php" style="font-size: 15px;color: white;">Logout</a></button></p>
    <h3 style="margin-left: 300px;margin-top: 170px;">Tambah Data Buku</h3>
    <br>
                                ...
                                <div class="col-md-12">
                                    <form method="POST">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="kode" style="margin-left:61px;width:300px;height: 20px;"name="kode" />

                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label>Kategori
                                            <select name="kategori" style="margin-left:80px;width: 302px;height: 20px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="judul_buku" style="margin-left: 60px;width: 300px;height: 20px;"name="judul_buku" />
                                            <br>
                                        </div>                                    
                                    <br>
                                    <input type="submit" name="ubah" value="Simpan" class="btn btn-primary"style="margin-left:145px;width: 100px;height: 25px;">
                                    <button style="background-color: royalblue; margin-left:100px;height: 25px;width: 100px;"><a href="../Admin/buku.php" style="color:white;">Kembali</button>
                                </div>
                            </div>
