...
<br>
 <p align="center" style="margin-top:1px; margin-left: 1200px">Anda Login Sebagai {(Admin)} <button style="width: 60px;margin-left:10px;background-color:orangered ;height:25px"><a href="../login/index.php" style="font-size: 15px;color: white;">Logout</a></button></p>
    <h3 style="margin-left: 300px;margin-top: 100px;font-size: 2em;">Laporan Peminjaman</h3>
    <form method="POST" action="hal_laporan.php" style="margin-left:300px;margin-top: 50px;">
        <label>Tanggal Awal</label>
        <input type="date" name="tanggal1" required="required" style="margin-left:42px;width: 200px;height: 25px;">
        <br>
        <br>
        <label>Tanggal Akhir</label>
        <input type="date" name="tanggal2" required="required" style="margin-left:40px;width:200px;height: 25px;">
        <br>
        <br>
        <input type="submit" class="btn btn-primary" name="filter" value="Cetak Laporan" style="margin-left:141px;height: 25px;width: 100px;">
    </form>
</body>
</html>