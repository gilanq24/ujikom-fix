    ...
    $tanggal    =$_POST['tanggal'];
        ...
        $insert =mysqli_query($koneksi, "INSERT INTO pinjaman (kode,nis,nama_siswa,kode_buku,judul_buku,tanggal) VALUES ('$kode','$nis','$nama_siswa','$kode_buku','$judul_buku','$tanggal')");
...
tbody tr td{
 ...
 <p align="center" style="margin-top:1px; margin-left: 1200px">Anda Login Sebagai {(Admin)} <button style="width: 60px;margin-left:10px;background-color:orangered ;height:25px"><a href="../login/index.php" style="font-size: 15px;color: white;">Logout</a></button></p>
  <h3 style="margin-left: 300px;margin-top:10px;font-size: 2em;">Tambah Data Peminjaman</h3>
  <br>
  <?php
  ...
  <form method="POST" style="margin-left:300px;">
    ...
    <label>NIS </label>  
                     ...
                     <option value="" disabled selected>Pilih/Ketik NIS</option> 
                          <?php   
                ...
                <script type="text/javascript">   
                     ...
                     <select name="kode_buku" id="kode" class="form-control" onchange='changeValues(this.value)' required style="margin-left:80px;width: 165px;">
                      <option value="" disabled selected >Pilih/Ketik Kode</option>  
                          <?php   
                ...
                <script type="text/javascript">   
                          ...
                          <input type="curent_timestamp" name="tanggal" value="<?php date_default_timezone_set('Asia/jakarta'); echo date('Y-m-d H:i:s'); ?>" readonly style="width: 160px;margin-left: 20px;" >
